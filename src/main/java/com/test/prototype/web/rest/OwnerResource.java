...
import com.test.prototype.domain.Owner;
import com.test.prototype.repository.OwnerRepository;
...
/**
 * REST controller for managing {@link com.test.prototype.domain.Owner}.
 */
@RestController
@RequestMapping("/api")
@Transactional
